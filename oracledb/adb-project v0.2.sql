...
INSERT INTO fide_licencias_empleado_tb (ID_Empleado, ID_Licencia, Fecha_Expedicion, Fecha_Vencimiento, id_estado) VALUES (4, 2, TO_DATE('2030-03-03', 'YYYY-MM-DD'), TO_DATE('2035-03-03', 'YYYY-MM-DD'), 7);
...
--Insercion de datos en la tabla
    INSERT INTO FIDE_USUARIOS_TB ( USUARIO, CONTRASENA, ID_ROL)
    VALUES (P_USUARIO, L_ENCRYPTED_PASSWORD, P_ID_ROL);
...
create or replace PROCEDURE FIDE_USUARIOS_TB_DESENCRIPTAR_DATOS_SP(
...
BEGIN
    ...
    SELECT CONTRASENA INTO L_ENCRYPTED_DATA FROM FIDE_USUARIOS_TB
    ...
    L_DECRYPTED_DATA:=DBMS_CRYPTO.DECRYPT(
        ...
        TYP=> DBMS_CRYPTO.ENCRYPT_AES256+DBMS_CRYPTO.CHAIN_CBC+DBMS_CRYPTO.PAD_PKCS5,
        KEY=> L_KEY);
    L_DESCRYPTED:=UTL_RAW.CAST_TO_VARCHAR2(L_DECRYPTED_DATA);
    P_CONTRASENA:= L_DESCRYPTED;

END FIDE_USUARIOS_TB_DESENCRIPTAR_DATOS_SP;
...
BEGIN
    BEGIN
    FIDE_USUARIOS_TB_DESENCRIPTAR_DATOS_SP(P_USUARIO, V_CONTRASENA);
    
    IF P_CONTRASENA = V_CONTRASENA THEN
